export const legalTexts = {
  Terminosdeuso: (company, email, address) => {
    return `<p><strong>${company}</strong>, como responsable del presente Sitio Web y de conformidad con lo dispuesto por la Ley Orgánica 15/1999, de 13 de diciembre, de Protección de Datos de Carácter Personal (LOPD) y por la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSICE), ha puesto en práctica aquellas políticas, medios y procedimientos técnicos y organizativos para garantizar y proteger la confidencialidad, integridad y disponibilidad de los datos de carácter personal de sus usuarios. Estos datos serán tratados en un/os fichero/s debidamente inscrito/s en la Agencia Española de Protección de Datos, de conformidad con lo establecido en la legislación vigente.</p>
            <p>En el caso de que los<span> </span><strong>datos</strong><span> </span>a facilitar<span> </span><strong>por el Usuario fueran necesarios</strong><span> </span><strong>para</strong><span> </span>que el equipo de<span> <strong>${company}</strong></span> pudiera i) responder a las<strong><span> </span>consultas</strong>, proporcionar informaciones requeridas por el Usuario; ii) realizar toda aquella prestación de<strong><span> </span>servicios</strong><span> </span>y/o productos contratados o suscritos por el Usuario; iii) proporcionar acceso al Usuario a determinadas funcionalidades del Sitio Web; o bien iv) realizar todas aquellas<span> </span><strong>actividades propias de</strong><span> <strong>${company}</strong></span> por la presente reseñadas,<span> <strong>${company}</strong></span><strong> informará de dicha obligatoriedad</strong><span> </span>al Usuario, indicándole qué datos son de necesaria cumplimentación. Mediante la indicación, facilitación o introducción de dichos datos y de conformidad con lo establecido en el artículo 6 de la L.O.P.D., el Usuario otorga consentimiento inequívoco a<span> <strong>${company}</strong></span><span> </span>para que proceda al tratamiento de los datos facilitados en pro de los fines mencionados anteriormente así como para el eventual envío de comunicaciones comerciales de<span> <strong>${company}</strong></span> que puedan ser del interés del usuario.</p>
            <p>La<span> </span><strong>entidad responsable de la base de datos</strong>,<strong><span> </span>así como los que intervengan</strong><span> </span>en cualquier fase del tratamiento y/o las entidades a quienes les hayan sido comunicadas -en su caso y en virtud de la correspondiente autorización conferida por el Usuario-, están<span> </span><strong>obligadas a observar el secreto profesional y a adoptar los niveles de protección y</strong><span> </span>las<strong><span> </span>medidas</strong><span> </span>técnicas y organizativas necesarias a su alcance que<span> </span><strong>garanticen la seguridad de los datos</strong><span> </span>de carácter personal, evitando, en la medida de lo posible, accesos no autorizados, modificaciones ilícitas, sustracciones y/o la pérdida de los datos, a fin de procurar el correspondiente nivel de seguridad a los ficheros de<span> <strong>${company}</strong></span>, según la naturaleza y sensibilidad de los datos facilitados por los usuarios del presente Sitio Web. Asimismo,<span> <strong>${company}</strong></span><span> </span>se compromete a tener implementadas las medidas de seguridad que correspondan en virtud de lo establecido en el Reglamento de Medidas de (R.D. 1720/2007).</p>
            <p>Los<span> </span><strong>usuarios tienen</strong><span> </span>reconocida por la indicada Ley Orgánica de Protección de Datos los<span> </span><strong>derechos de acceso, rectificación, cancelación y oposición y,</strong><span> </span>en su caso, el derecho a<span> </span><strong>revocar</strong><span> </span>en<span> </span><strong>cualquier momento</strong><span> </span>el<span> </span><strong>consentimiento</strong><span> </span>prestado a la recepción de comunicaciones comerciales mediante el envío de<span> </span><strong>correo electrónico a ${email}</strong><span> </span><strong>o carta</strong><span> </span>a<strong><span> ${address}</span><b>.</b></strong></p>
`;
  },
  Avisolegal: (company, email, address, phone, dni) => {

    return `<p><strong>1. Información corporativa. </strong>En virtud de las obligaciones establecidas por la Ley 34/2002, de Servicios de la Sociedad de la Información y de Comercio Electrónico, le informamos que el presente sitio web es propiedad de ${company} con C.I.F. ${dni} con domicilio en ${address} y con los siguientes datos de contacto: ${phone}/ ${email}.</p>
            <p ><strong>2. Protección de contenidos. </strong>El usuario reconoce y acepta que todos los derechos de propiedad industrial e intelectual sobre los contenidos y/o cualesquiera otros elementos insertados por ${company} en el presente Sitio Web (incluyendo, a título meramente enunciativo y no limitativo, todos aquellos elementos que conforman la apariencia visual, imagen gráfica y otros estímulos sensoriales del sitio web o «look and feel»: marcas, logotipos, nombres comerciales, textos, imágenes, gráficos, diseños, sonidos, bases de datos, software, diagramas de flujo, presentación, arquitectura de navegación, así como los códigos fuente de las páginas web) pertenecen a ${company} y/o a terceros a los cuales les han cedido sus derechos.</p>
            ...
            <p >El usuario se obliga a abstenerse de utilizar los contenidos del Sitio Web con fines o efectos ilícitos, prohibidos o contrarios a los aquí establecidos, lesivos de los derechos e intereses de ${company}, de los demás usuarios, de terceros o que de cualquier forma puedan dañar, inutilizar, sobrecargar o deteriorar el presente Sitio Web o impedir la normal utilización o disfrute del mismo por parte de los usuarios.</p>
            <p >${company} no responderá de ninguna consecuencia, daño o perjuicio que pudiera derivarse de dicho acceso o uso o del incumplimiento de las presentes condiciones, términos y políticas ni se hará responsable de los errores de seguridad que se puedan producir ni de los daños que puedan causarse al sistema informático del usuario (hardware y software) o a los ficheros o documentos almacenados en el mismo como consecuencia de: (i) la presencia de un virus en el ordenador del usuario que sea utilizado para la conexión a los servicios y/o productos ofrecidos por ${company} a través de su Sitio Web; (ii) un mal funcionamiento del navegador; (iii) el uso de versiones no actualizadas del mismo.</p>
            <p ><strong>4. Enlaces a terceros. </strong>En el presente Sitio Web se pueden utilizar enlaces con otras páginas o sitios web. ${company} no se responsabiliza ni del contenido ni de las medidas de seguridad adoptadas por cualquier otra página o sitio web a través del cual se tiene acceso desde el presente Sitio Web, sitios a los que accede el interesado bajo su exclusiva responsabilidad.</p>
            <p >Asimismo, tampoco se garantiza la ausencia de virus u otros elementos en los contenidos enlazados desde el Sitio Web de ${company} que puedan producir alteraciones en el sistema informático (hardware y software) y/o en los documentos o los ficheros del Usuario, excluyendo asimismo a ${company} de toda responsabilidad derivada de los daños de cualquier índole ocasionados por todo lo anterior.</p>
            <p ><strong>5. Redes sociales.</strong></p>
            <p >Le informamos qué ${company} puede tener presencia en redes sociales. El tratamiento de los datos que se lleve a cabo de las personas que se hagan seguidoras en las redes sociales (y/o realicen cualquier vínculo o acción de conexión a través de las redes sociales) de las páginas oficiales de ${company} se regirá por este apartado, así como por aquellas condiciones de uso, políticas de privacidad y normativas de acceso que pertenezcan a la red social que proceda en cada caso y aceptadas previamente por el usuario.</p>
            <p >${company} tratará sus datos con las finalidades de administrar correctamente su presencia en la red social, informándole de actividades productos o servicios de ${company}, así como para cualquier otra finalidad que las normativas de las Redes Sociales permitan.</p>
            ...
            <ul>
                ...
                <li>Que atenten contra los derechos fundamentales de las personas, falten a la cortesía en la red, molesten o puedan generar opiniones negativas en nuestros usuarios o terceros y en general cualesquiera sean los contenidos que ${company} considere no apropiados.</li>
            ...
            <p >Asimismo, ${company} se reserva la potestad de retirar, sin previo aviso del sitio web o de la red social corporativa aquellos contenidos que se consideren no apropiados.</p>
  ...
  Declaraciondeaccesibilidad: (company, address, url) => {
    ...
    return `<p >Actualizado: ${fecha}</p>
            ...
            <p >A través de nuestros formulario de contacto, o de manera presencial en: ${address}</p>
...
<h2 style="text-align: center;font-weight: bolder;">Aviso Legal</h2>

<strong></strong><strong>1. Información corporativa. </strong>En virtud de las obligaciones establecidas por la Ley 34/2002, de Servicios de la Sociedad de la Información y de Comercio Electrónico, le informamos que el presente sitio web es propiedad de Nadia Martín García con C.I.F. 78599790G con domicilio en C/ Dulcinea, 136 B,Puerto del Rosario,Las Palmas y con los siguientes datos de contacto: 622178738/ nadiamnga@gmail.com.

<strong>2. Protección de contenidos. </strong>El usuario reconoce y acepta que todos los derechos de propiedad industrial e intelectual sobre los contenidos y/o cualesquiera otros elementos insertados por Nadia Martín García en el presente Sitio Web (incluyendo, a título meramente enunciativo y no limitativo, todos aquellos elementos que conforman la apariencia visual, imagen gráfica y otros estímulos sensoriales del sitio web o «look and feel»: marcas, logotipos, nombres comerciales, textos, imágenes, gráficos, diseños, sonidos, bases de datos, software, diagramas de flujo, presentación, arquitectura de navegación, así como los códigos fuente de las páginas web) pertenecen a Nadia Martín García y/o a terceros a los cuales les han cedido sus derechos.
...
Sin perjuicio de todo lo anterior, si el Usuario o un tercero estima que algún contenido del Sitio Web pudiera vulnerar derechos de propiedad intelectual e industrial, rogamos así lo pongan en nuestro conocimiento a la mayor brevedad posible.

<strong>3. Acceso y uso del sitio web. </strong>Tanto el acceso al Sitio Web como el uso no consentido que pueda efectuarse de la información contenida en el mismo es de la exclusiva responsabilidad de quien lo realiza.
...
El usuario se obliga a abstenerse de utilizar los contenidos del Sitio Web con fines o efectos ilícitos, prohibidos o contrarios a los aquí establecidos, lesivos de los derechos e intereses de Nadia Martín García, de los demás usuarios, de terceros o que de cualquier forma puedan dañar, inutilizar, sobrecargar o deteriorar el presente Sitio Web o impedir la normal utilización o disfrute del mismo por parte de los usuarios.

Nadia Martín García no responderá de ninguna consecuencia, daño o perjuicio que pudiera derivarse de dicho acceso o uso o del incumplimiento de las presentes condiciones, términos y políticas ni se hará responsable de los errores de seguridad que se puedan producir ni de los daños que puedan causarse al sistema informático del usuario (hardware y software) o a los ficheros o documentos almacenados en el mismo como consecuencia de: (i) la presencia de un virus en el ordenador del usuario que sea utilizado para la conexión a los servicios y/o productos ofrecidos por Nadia Martín García a través de su Sitio Web; (ii) un mal funcionamiento del navegador; (iii) el uso de versiones no actualizadas del mismo.

<strong>4. Enlaces a terceros. </strong>En el presente Sitio Web se pueden utilizar enlaces con otras páginas o sitios web. Nadia Martín García no se responsabiliza ni del contenido ni de las medidas de seguridad adoptadas por cualquier otra página o sitio web a través del cual se tiene acceso desde el presente Sitio Web, sitios a los que accede el interesado bajo su exclusiva responsabilidad.

Asimismo, tampoco se garantiza la ausencia de virus u otros elementos en los contenidos enlazados desde el Sitio Web de Nadia Martín García que puedan producir alteraciones en el sistema informático (hardware y software) y/o en los documentos o los ficheros del Usuario, excluyendo asimismo a Nadia Martín García de toda responsabilidad derivada de los daños de cualquier índole ocasionados por todo lo anterior.

<strong>5. Redes sociales.</strong>

Le informamos qué Nadia Martín García puede tener presencia en redes sociales. El tratamiento de los datos que se lleve a cabo de las personas que se hagan seguidoras en las redes sociales (y/o realicen cualquier vínculo o acción de conexión a través de las redes sociales) de las páginas oficiales de Nadia Martín García se regirá por este apartado, así como por aquellas condiciones de uso, políticas de privacidad y normativas de acceso que pertenezcan a la red social que proceda en cada caso y aceptadas previamente por el usuario.

Nadia Martín García tratará sus datos con las finalidades de administrar correctamente su presencia en la red social, informándole de actividades productos o servicios de Nadia Martín García, así como para cualquier otra finalidad que las normativas de las Redes Sociales permitan.

Queda prohibida la publicación de contenidos:
<ul>
  <li>Que sean presuntamente ilícitos por la normativa nacional, comunitaria o internacional o que realicen actividades presuntamente ilícitas o contravengan los principios de la buena fe.</li>
  <li>Que atenten contra los derechos fundamentales de las personas, falten a la cortesía en la red, molesten o puedan generar opiniones negativas en nuestros usuarios o terceros y en general cualesquiera sean los contenidos que Nadia Martín García considere no apropiados.</li>
  <li>Y en general que contravengan los principios de legalidad, honradez, responsabilidad, protección de la dignidad humana, protección de menores, protección del orden público, la protección de la vida privada, la protección del consumidor y los derechos de propiedad intelectual e industrial.</li>
</ul>
Asimismo, Nadia Martín García se reserva la potestad de retirar, sin previo aviso del sitio web o de la red social corporativa aquellos contenidos que se consideren no apropiados.
