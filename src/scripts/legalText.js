...
`;
    ...
    Avisolegal: (company, email, address,phone,dni) => {
      return `<p><strong>1. Información corporativa. </strong>En virtud de las obligaciones establecidas por la Ley 34/2002, de Servicios de la Sociedad de la Información y de Comercio Electrónico, le informamos que el presente sitio web es propiedad de ${valueInputs[0]} con C.I.F. ${valueInputs[4]} con domicilio en ${valueInputs[2]} y con los siguientes datos de contacto: ${valueInputs[3]}/ ${valueInputs[1]}.</p>
            ...
            <p >El usuario se obliga a abstenerse de utilizar los contenidos del Sitio Web con fines o efectos ilícitos, prohibidos o contrarios a los aquí establecidos, lesivos de los derechos e intereses de ${valueInputs[0]}, de los demás usuarios, de terceros o que de cualquier forma puedan dañar, inutilizar, sobrecargar o deteriorar el presente Sitio Web o impedir la normal utilización o disfrute del mismo por parte de los usuarios.</p>
            <p >${valueInputs[0]} no responderá de ninguna consecuencia, daño o perjuicio que pudiera derivarse de dicho acceso o uso o del incumplimiento de las presentes condiciones, términos y políticas ni se hará responsable de los errores de seguridad que se puedan producir ni de los daños que puedan causarse al sistema informático del usuario (hardware y software) o a los ficheros o documentos almacenados en el mismo como consecuencia de: (i) la presencia de un virus en el ordenador del usuario que sea utilizado para la conexión a los servicios y/o productos ofrecidos por ${valueInputs[0]} a través de su Sitio Web; (ii) un mal funcionamiento del navegador; (iii) el uso de versiones no actualizadas del mismo.</p>
            <p ><strong>4. Enlaces a terceros. </strong>En el presente Sitio Web se pueden utilizar enlaces con otras páginas o sitios web. ${valueInputs[0]} no se responsabiliza ni del contenido ni de las medidas de seguridad adoptadas por cualquier otra página o sitio web a través del cual se tiene acceso desde el presente Sitio Web, sitios a los que accede el interesado bajo su exclusiva responsabilidad.</p>
            <p >Asimismo, tampoco se garantiza la ausencia de virus u otros elementos en los contenidos enlazados desde el Sitio Web de ${valueInputs[0]} que puedan producir alteraciones en el sistema informático (hardware y software) y/o en los documentos o los ficheros del Usuario, excluyendo asimismo a ${valueInputs[0]} de toda responsabilidad derivada de los daños de cualquier índole ocasionados por todo lo anterior.</p>
            <p ><strong>5. Redes sociales.</strong></p>
            <p >Le informamos qué ${valueInputs[0]} puede tener presencia en redes sociales. El tratamiento de los datos que se lleve a cabo de las personas que se hagan seguidoras en las redes sociales (y/o realicen cualquier vínculo o acción de conexión a través de las redes sociales) de las páginas oficiales de ${valueInputs[0]} se regirá por este apartado, así como por aquellas condiciones de uso, políticas de privacidad y normativas de acceso que pertenezcan a la red social que proceda en cada caso y aceptadas previamente por el usuario.</p>
            <p >${valueInputs[0]} tratará sus datos con las finalidades de administrar correctamente su presencia en la red social, informándole de actividades productos o servicios de ${valueInputs[0]}, así como para cualquier otra finalidad que las normativas de las Redes Sociales permitan.</p>
            ...
            <ul>
                ...
                <li>Que atenten contra los derechos fundamentales de las personas, falten a la cortesía en la red, molesten o puedan generar opiniones negativas en nuestros usuarios o terceros y en general cualesquiera sean los contenidos que ${valueInputs[0]} considere no apropiados.</li>
            ...
            <p >Asimismo, ${valueInputs[0]} se reserva la potestad de retirar, sin previo aviso del sitio web o de la red social corporativa aquellos contenidos que se consideren no apropiados.</p>
