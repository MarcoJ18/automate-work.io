...
btn.addEventListener('click', ()=>{
    ...
    if(data === 'terminos'){
        ...
        // Clean the current output and add new input
        output.innerHTML = `
        <div id="output" class="bg-white text-black m-10 flex flex-col max-w-100 p-5 rounded">
            <label class="font-bold text-xl mb-3"for="nombre">Nombre &rarr;</label>
            <input type="text" id="nombre" class="mb-3">
            <label class="font-bold text-xl mb-3"for="nombre">Dirección &rarr;</label>
            <input type="text" id="nombre" class="mb-3">
            <label class="font-bold text-xl mb-3"for="nombre">Correo &rarr;</label>
            <input type="text" id="nombre" class="mb-3">

            <button class="outline bg-black text-white hover:bg-white hover:text-blue-700 font-semibold hover:text-white py-2 px-4 rounded mt-2">COPY</button>
        </div>
            `;
        ...
        // Add text in each label
        //labelNombre.textContent = 'Nombre de la empresa:';
        //labelCorreo.textContent = "Correo electronico:";
        //labelDireccion.textContent = "Lugar de la empresa:";

        // Create the button and add class 
        ...
        //fragment.appendChild(labelCorreo);
        //fragment.appendChild(correo);
        //fragment.appendChild(labelDireccion);
        //fragment.appendChild(direccion);
        //fragment.appendChild(sender);
        //output.appendChild(fragment);

        // Add event listener to btn
        const btnSender = document.querySelector('.sender');
    ...
    if(data === 'aviso'){
        ...
        let correo = prompt('Correo electronico:',null);
        let direccion = prompt('Lugar de la empresa:',null);
        let numero = prompt('Número de telefono de la empresa:',null);
        let CIF = prompt('CIF o DNI de la empresa:',null);
        ...
        <p ><strong>2. Protección de contenidos. </strong>El usuario reconoce y acepta que todos los derechos de propiedad industrial e intelectual sobre los contenidos y/o cualesquiera otros elementos insertados por ${nombre} en el presente Sitio Web (incluyendo, a título meramente enunciativo y no limitativo, todos aquellos elementos que conforman la apariencia visual, imagen gráfica y otros estímulos sensoriales del sitio web o «look and feel»: marcas, logotipos, nombres comerciales, textos, imágenes, gráficos, diseños, sonidos, bases de datos, software, diagramas de flujo, presentación, arquitectura de navegación, así como los códigos fuente de las páginas web) pertenecen a ${nombre} y/o a terceros a los cuales les han cedido sus derechos.</p>
        ...
        <p >El usuario se obliga a abstenerse de utilizar los contenidos del Sitio Web con fines o efectos ilícitos, prohibidos o contrarios a los aquí establecidos, lesivos de los derechos e intereses de ${nombre}, de los demás usuarios, de terceros o que de cualquier forma puedan dañar, inutilizar, sobrecargar o deteriorar el presente Sitio Web o impedir la normal utilización o disfrute del mismo por parte de los usuarios.</p>
        <p >${nombre} no responderá de ninguna consecuencia, daño o perjuicio que pudiera derivarse de dicho acceso o uso o del incumplimiento de las presentes condiciones, términos y políticas ni se hará responsable de los errores de seguridad que se puedan producir ni de los daños que puedan causarse al sistema informático del usuario (hardware y software) o a los ficheros o documentos almacenados en el mismo como consecuencia de: (i) la presencia de un virus en el ordenador del usuario que sea utilizado para la conexión a los servicios y/o productos ofrecidos por ${nombre} a través de su Sitio Web; (ii) un mal funcionamiento del navegador; (iii) el uso de versiones no actualizadas del mismo.</p>
        <p ><strong>4. Enlaces a terceros. </strong>En el presente Sitio Web se pueden utilizar enlaces con otras páginas o sitios web. ${nombre} no se responsabiliza ni del contenido ni de las medidas de seguridad adoptadas por cualquier otra página o sitio web a través del cual se tiene acceso desde el presente Sitio Web, sitios a los que accede el interesado bajo su exclusiva responsabilidad.</p>
        <p >Asimismo, tampoco se garantiza la ausencia de virus u otros elementos en los contenidos enlazados desde el Sitio Web de ${nombre} que puedan producir alteraciones en el sistema informático (hardware y software) y/o en los documentos o los ficheros del Usuario, excluyendo asimismo a ${nombre} de toda responsabilidad derivada de los daños de cualquier índole ocasionados por todo lo anterior.</p>
        <p ><strong>5. Redes sociales.</strong></p>
        <p >Le informamos qué ${nombre} puede tener presencia en redes sociales. El tratamiento de los datos que se lleve a cabo de las personas que se hagan seguidoras en las redes sociales (y/o realicen cualquier vínculo o acción de conexión a través de las redes sociales) de las páginas oficiales de ${nombre} se regirá por este apartado, así como por aquellas condiciones de uso, políticas de privacidad y normativas de acceso que pertenezcan a la red social que proceda en cada caso y aceptadas previamente por el usuario.</p>
        <p >${nombre} tratará sus datos con las finalidades de administrar correctamente su presencia en la red social, informándole de actividades productos o servicios de ${nombre}, así como para cualquier otra finalidad que las normativas de las Redes Sociales permitan.</p>
        ...
        <ul >
            ...
            <li>Que atenten contra los derechos fundamentales de las personas, falten a la cortesía en la red, molesten o puedan generar opiniones negativas en nuestros usuarios o terceros y en general cualesquiera sean los contenidos que ${nombre} considere no apropiados.</li>
        ...
        <p >Asimismo, ${nombre} se reserva la potestad de retirar, sin previo aviso del sitio web o de la red social corporativa aquellos contenidos que se consideren no apropiados.</p>
    ...
    if(data === 'accesibilidad'){
        ...
        <p >A través de nuestros formulario de contacto, o de manera presencial en: ${direccion}</p>
        ...
        output.innerHTML = accesibilidad;
